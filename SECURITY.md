...
| VTE shell spawn | Configured shell must be an absolute executable file. Spawned shells receive only the ForkTTY environment variables required for socket/workspace targeting. |
