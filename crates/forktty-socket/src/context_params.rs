...
use crate::{
    optional_u64_param, resolve_workspace_id_for_metadata, DispatchError, SocketAppState,
    DEFAULT_CONTEXT_SNAPSHOT_TAIL_LINES, DEFAULT_CONTEXT_SNAPSHOT_TAIL_MAX_BYTES,
