...
#[cfg(feature = "browser")]
fn show_browser_import_dialog(parent: &adw::ApplicationWindow, state: &SocketAppState) {
    let dialog = gtk::Window::builder()
...
#[cfg(feature = "browser")]
fn browser_import_source_rows(discovered: &Value) -> Vec<BrowserImportSourceRow> {
    let mut rows = Vec::new();
...
#[cfg(feature = "browser")]
fn browser_import_dialog_params(
...
#[cfg(feature = "browser")]
fn browser_import_count(value: &Value, key: &str) -> usize {
    value.get(key).and_then(Value::as_u64).unwrap_or(0) as usize
}

#[cfg(feature = "browser")]
fn browser_import_preview_summary(value: &Value) -> String {
...
#[cfg(feature = "browser")]
fn browser_import_run_summary(value: &Value) -> String {
    let total = value.get("total").unwrap_or(&Value::Null);
