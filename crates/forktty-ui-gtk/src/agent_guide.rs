...
Read-only first: use workspace_list, surface_list, topology_tree, surface_read_text, surface_capture_tail, agent_list, agent_health, agent_reclaim_plan, status_summary, workflow_list, workflow_get, and workflow_replay to inspect state before changing focus, sending text, resuming agents, or changing worktrees.
