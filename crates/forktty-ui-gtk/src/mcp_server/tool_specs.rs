        ...
        ToolSpec {
            ...
            input_schema: object_schema(
                ...
                json!({
                    ...
                    "task_kind": string_prop("Optional normalized task kind hint from the caller: tiny_answer, repo_inspection, focused_bugfix, feature_implementation, review_only, parallel_research, parallel_experiment, verify_fix_loop, or long_running_team_run. Use this to pass clear user intent across languages without relying on ForkTTY keyword guessing."),
                    ...
                    "user_visible": boolean_prop("Optional override for whether the task is likely to change user-visible behavior, docs, CLI output, UI, packaging, or public docs. When omitted, ForkTTY infers this from mutating task_kind hints and high-confidence goal text."),
                }),
            ),
        },
        ToolSpec {
