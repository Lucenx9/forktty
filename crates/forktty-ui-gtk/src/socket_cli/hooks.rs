...
use install::{
    agent_spec, antigravity_config_path, antigravity_script_path, build_hook_remove_plan,
    build_hook_setup_plan, build_hook_setup_plan_with_profile, claude_config_path,
    codex_config_path, default_hook_setup_agents, ensure_private_antigravity_hook_dirs,
    hook_setup_profile_name, is_claude_high_frequency_event, is_forktty_managed_entry,
    opencode_plugin_path, read_opencode_plugin_file, supported_agents,
