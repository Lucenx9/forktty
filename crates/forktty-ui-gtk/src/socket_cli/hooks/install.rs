...
pub(in crate::socket_cli) const FORKTTY_LAUNCHER = {launcher};
pub(in crate::socket_cli) const DISABLED_ENV = "FORKTTY_OPENCODE_HOOKS_DISABLED";
pub(in crate::socket_cli) const HOOK_TIMEOUT_MS = {timeout};
pub(in crate::socket_cli) const MAX_INPUT_BYTES = {max_input_bytes};
pub(in crate::socket_cli) const MAX_SANITIZE_DEPTH = 32;
pub(in crate::socket_cli) const MAX_SANITIZE_ITEMS = 128;
pub(in crate::socket_cli) const MAX_SANITIZE_NODES = 4096;
pub(in crate::socket_cli) const textEncoder = new TextEncoder();
...
pub(in crate::socket_cli) const eventMap = {{
