...
### Fixed
- Atomic profile metadata saves now preserve an existing `profiles.json` file mode on Unix, avoiding accidental permission relaxation when replacing the file.
