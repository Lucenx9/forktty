...
### Fixed
- Browser imports now copy temporary SQLite databases and WAL/SHM sidecars into a private directory with newly-created `0600` files, preventing local temp-file races from exposing browser data.
