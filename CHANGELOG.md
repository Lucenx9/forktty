...
### Fixed
- Session locking now creates the state directory and lock file with private permissions, preventing other local users from reading or pre-locking `session.lock` to block startup.
