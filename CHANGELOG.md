...
### Fixed
- Antigravity hook setup now hardens the generated wrapper and config directories to owner-only permissions before writing executable hook scripts, preventing local users from replacing wrappers through group/world-writable directories.
