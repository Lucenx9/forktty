...
### Fixed
- Browser automation CLI commands now support `--value-file`/`--script-file` (with `-` for stdin) so sensitive fill values and scripts do not have to be exposed in process arguments.
