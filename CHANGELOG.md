...
### Fixed
- Browser imports now process each selected source profile one at a time instead of buffering every profile in an import entry at once, reducing peak memory use for large multi-profile imports.
