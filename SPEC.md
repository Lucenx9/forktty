...
| Feed | `feed.list` |
| Team | `team.list`, `team.get`, `team.upsert`, `team.worker.upsert`, `team.worker.heartbeat`, `team.task.upsert`, `team.message.send`, `team.message.ack`, `team.inbox`, `team.summary`, `team.events` |
...
`workspace_list`, `surface_list`, `topology_tree`, `surface_read_text`, `surface_capture_tail`, `agent_list`, `agent_health`, `agent_reclaim_plan`, `agent_resume`, `team_list`, `team_get`, `team_upsert`, `team_worker_upsert`, `team_worker_heartbeat`, `team_task_upsert`, `team_message_send`, `team_message_ack`, `team_inbox`, `team_summary`, `team_events`, `status_summary`, `surface_split`, `surface_send_text`,
