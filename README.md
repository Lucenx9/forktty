...
[![Release](https://img.shields.io/github/v/release/Lucenx9/forktty?include_prereleases)](https://github.com/Lucenx9/forktty/releases/tag/v0.2.0-alpha.15)
...
[v0.2.0-alpha.15 release](https://github.com/Lucenx9/forktty/releases/tag/v0.2.0-alpha.15).
Each release ships:

- `forktty-0.2.0-alpha.15-x86_64.AppImage` — recommended portable Linux package.
- `forktty-0.2.0-alpha.15-x86_64.AppImage.zsync` — AppImage delta-update metadata for external AppImage managers.
- `forktty_0.2.0.alpha.15_amd64.deb` — Debian/Ubuntu package.
...
```bash
chmod +x forktty-0.2.0-alpha.15-x86_64.AppImage
./forktty-0.2.0-alpha.15-x86_64.AppImage
```
...
```bash
GSK_RENDERER=gl ./forktty-0.2.0-alpha.15-x86_64.AppImage
```
...
```bash
sudo apt install ./forktty_0.2.0.alpha.15_amd64.deb
# or, if apt cannot read the file path directly:
sudo dpkg -i forktty_0.2.0.alpha.15_amd64.deb
sudo apt -f install
```
