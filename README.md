...
[![Release](https://img.shields.io/github/v/release/Lucenx9/forktty?include_prereleases)](https://github.com/Lucenx9/forktty/releases/tag/v0.2.0-alpha.10)
...
[Download v0.2.0-alpha.10 AppImage](https://github.com/Lucenx9/forktty/releases/download/v0.2.0-alpha.10/forktty-0.2.0-alpha.10-x86_64.AppImage)

</div>

> **Status**: Early alpha (v0.2.0-alpha.10). ForkTTY is Linux-only and the GTK/Ghostty runtime is now the primary implementation. The AppImage is the primary Linux download for this alpha; the Debian package remains available for Debian/Ubuntu users.
...
[v0.2.0-alpha.10 release](https://github.com/Lucenx9/forktty/releases/tag/v0.2.0-alpha.10).
Each release ships:

- `forktty-0.2.0-alpha.10-x86_64.AppImage` — recommended portable Linux package.
- `forktty_0.2.0.alpha.10_amd64.deb` — Debian/Ubuntu package.
...
```bash
chmod +x forktty-0.2.0-alpha.10-x86_64.AppImage
./forktty-0.2.0-alpha.10-x86_64.AppImage
```
...
```bash
GSK_RENDERER=ngl ./forktty-0.2.0-alpha.10-x86_64.AppImage
```

### Debian / Ubuntu (.deb)

```bash
sudo apt install ./forktty_0.2.0.alpha.10_amd64.deb
# or, if apt cannot read the file path directly:
sudo dpkg -i forktty_0.2.0.alpha.10_amd64.deb
sudo apt -f install
```
